...
PROJECT_DIR="/home/ajhope/$PROJECT_NAME"
DOMAIN="ajhopefoundation.org" # Replace with actual domain
USER="ajhope"           # Replace if using a different non-root user
GUNICORN_WORKERS=3
...
echo "========================================================="
sudo chmod g+x /home/ajhope
sudo usermod -a -G ajhope www-data
